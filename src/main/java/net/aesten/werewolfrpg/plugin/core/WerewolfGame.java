...
import net.aesten.werewolfrpg.plugin.items.registry.PlayerItem;
import net.aesten.werewolfrpg.plugin.items.registry.ItemManager;
import net.aesten.werewolfrpg.plugin.map.MapManager;
import net.aesten.werewolfrpg.plugin.map.WorldManager;
import net.aesten.werewolfrpg.plugin.shop.ShopManager;
import net.aesten.werewolfrpg.plugin.skeleton.SkeletonManager;
import net.aesten.werewolfrpg.plugin.statistics.ScoreManager;
import net.aesten.werewolfrpg.plugin.statistics.Tracker;
