...
public class MapManager {
    ...
    public void saveMaps() {
        for (WerewolfMap map : maps.values()) {
            AzaleaConfigurationApi.getFileConfiguration(WerewolfRpg.getPlugin(),  "wwrpg-maps" + File.separator + map.getName()).save(map);
        }
    }
    ...
    public boolean createMap(String name, World world) {
        ...
        AzaleaConfigurationApi.getFileConfiguration(WerewolfRpg.getPlugin(), name).load(newMap);
